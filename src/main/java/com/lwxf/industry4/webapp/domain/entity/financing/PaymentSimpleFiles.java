...
public class PaymentSimpleFiles extends IdEntity  {
	...
	@Column(type = Types.CHAR,length = 13,nullable = false,name = "payment_simple",displayName = "日常账id")
	private String paymentSimple;

    public PaymentSimpleFiles() {
     } 
	...
	public RequestResult validateFields() {
		...
		if (this.paymentSimple == null) {
			validResult.put("paymentSimple", AppBeanInjector.i18nUtil.getMessage("VALIDATE_NOTNULL"));
		}else{
 			if (LwxfStringUtils.getStringLength(this.paymentSimple) > 13) {
				validResult.put("paymentSimple", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
			}
		}
	...
	public void setPaymentSimple(String paymentSimple){
		this.paymentSimple=paymentSimple;
	}

	public String getPaymentSimple(){
		return paymentSimple;
	}


	public static PaymentSimpleFiles creator(UploadInfo uploadInfo, UploadType uploadType, String paymentId){
		PaymentSimpleFiles paymentFiles = new PaymentSimpleFiles();
		...
		paymentFiles.setPaymentSimple(paymentId);
