 ...
 */
@Repository("employeeCertificateDao")
public class EmployeeCertificateDaoImpl extends BaseDaoImpl<EmployeeCertificate, String> implements EmployeeCertificateDao {
	...
	public PaginatedList<EmployeeCertificate> selectByFilter(PaginatedFilter paginatedFilter) {
		...
		PageList<EmployeeCertificate> pageList = (PageList) this.getSqlSession().selectList(sqlId, paginatedFilter.getFilters(), pageBounds);
