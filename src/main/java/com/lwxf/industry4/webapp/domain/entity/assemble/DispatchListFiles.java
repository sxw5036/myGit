...
/**
 * 功能：dispatch_list_files 实体类
 *
 * @author：SunXianWei(17838625030@163.com)
 * @created：2018-12-19 02:58 
 * @version：2018 Version：1.0 
 * @dept：老屋新房 Created with IntelliJ IDEA 
 */ 
@Table(name = "dispatch_list_files",displayName = "dispatch_list_files")
public class DispatchListFiles extends IdEntity  {
	...
	@Column(type = Types.CHAR,length = 13,nullable = false,name = "dispatch_list_id",displayName = "所属资源的id：当type为0时，为custom_order_demand的id；当type为1时，为custom_order_design的id")
	private String dispatchListId;

    public DispatchListFiles() {  
     } 
	...
	private final static List<String> propertiesList = Arrays.asList("id","path","fullPath","mime","name","originalMime","status","creator","created","dispatchListId");
