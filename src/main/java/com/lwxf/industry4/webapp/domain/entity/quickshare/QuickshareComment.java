...
/**
 * 功能：quickshare_comment 实体类
 *
 * @author：SunXianWei(17838625030@163.com)
 * @created：2019-03-02 11:57 
 * @version：2018 Version：1.0 
 * @dept：老屋新房 Created with IntelliJ IDEA 
 */ 
@Table(name = "quickshare_comment",displayName = "quickshare_comment")
public class QuickshareComment extends IdEntity  {
	...
	@Column(type = Types.CHAR,length = 13,nullable = false,name = "creator",displayName = "创建人（会员id），关联会员表")
	...
	private final static List<String> propertiesList = Arrays.asList("id","quickshareId","parentId","parentCreator","creator","content","disabled","created");
