...
public class CityArea extends IdEntity  {
	...
	public RequestResult validateFields() {
		...
		if (this.parentId == null) {
			validResult.put("parentId", AppBeanInjector.i18nUtil.getMessage("VALIDATE_NOTNULL"));
		}else{
		...
		if (LwxfStringUtils.getStringLength(this.mergerName) > 100) {
			validResult.put("mergerName", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.shortName) > 100) {
			validResult.put("shortName", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.mergerShortName) > 100) {
			validResult.put("mergerShortName", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.cityCode) > 5) {
			validResult.put("cityCode", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.zipCode) > 6) {
			validResult.put("zipCode", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.namePinyin) > 50) {
			validResult.put("namePinyin", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.nameJianpin) > 10) {
			validResult.put("nameJianpin", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
		if (LwxfStringUtils.getStringLength(this.fisrtChar) > 1) {
			validResult.put("fisrtChar", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
	...
	public static RequestResult validateFields(MapContext map) {
		...
		if(map.containsKey("levelType")) {
			if (!DataValidatorUtils.isByte1(map.getTypedValue("levelType",String.class))) {
				validResult.put("levelType", AppBeanInjector.i18nUtil.getMessage("VALIDATE_INCORRECT_DATA_FORMAT"));
			}
		}
