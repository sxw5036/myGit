package com.lwxf.industry4.webapp.domain.dao.customer;
 ...
 */
@IBatisSqlTarget
public interface CompanyCustomerDao extends BaseDao<CompanyCustomer, String> {
	...
	List<CompanyCustomer> findCustomerListByCid(String companyId);
