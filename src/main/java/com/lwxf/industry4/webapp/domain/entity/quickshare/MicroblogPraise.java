...
public class MicroblogPraise extends AbstractNoIdEntity {
	...
	public RequestResult validateFields() {
		...
		if (this.memberId == null) {
			validResult.put("memberId", AppBeanInjector.i18nUtil.getMessage("VALIDATE_NOTNULL"));
		}else{
 			if (LwxfStringUtils.getStringLength(this.memberId) > 13) {
				validResult.put("memberId", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
			}
		}
