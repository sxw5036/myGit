 ...
 */
@Repository("employeeExperienceDao")
public class EmployeeExperienceDaoImpl extends BaseDaoImpl<EmployeeExperience, String> implements EmployeeExperienceDao {
	...
	public PaginatedList<EmployeeExperience> selectByFilter(PaginatedFilter paginatedFilter) {
		...
		PageList<EmployeeExperience> pageList = (PageList) this.getSqlSession().selectList(sqlId, paginatedFilter.getFilters(), pageBounds);
