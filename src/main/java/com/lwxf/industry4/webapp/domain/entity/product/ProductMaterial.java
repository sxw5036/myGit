 ...
 */ 
@Table(name = "product_material",displayName = "product_material")
public class ProductMaterial extends IdEntity  {
	private static final long serialVersionUID = 1L;
	@Column(type = Types.VARCHAR,length = 50,nullable = false,name = "name",displayName = "材质名称")
	protected String name;
	@Column(type = Types.VARCHAR,length = 100,name = "notes",displayName = "说明")
	protected String notes;
	@Column(type = Types.VARCHAR,length = 50,updatable = false,name = "product_category_id",displayName = "产品分类id")
	...
	public ProductMaterial(String id,String name, String notes, String productCategoryId) {
		this.id = id;
		this.name = name;
		this.notes = notes;
		this.productCategoryId = productCategoryId;
