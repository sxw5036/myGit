 ...
 */ 
@Table(name = "quickshare",displayName = "quickshare")
public class Quickshare extends IdEntity  {
	private static final long serialVersionUID = 1L;
	@Column(type = Types.CHAR,length = 13,nullable = false,name = "creator",displayName = "创建者，关联memberID")
	...
	private final static List<String> propertiesList = Arrays.asList("id","creator","content","type","status","created");
