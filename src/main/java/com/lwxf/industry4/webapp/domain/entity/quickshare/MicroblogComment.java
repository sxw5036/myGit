...
public class MicroblogComment extends IdEntity  {
	...
	public RequestResult validateFields() {
		...
		if (this.microblogId == null) {
			validResult.put("microblogId", AppBeanInjector.i18nUtil.getMessage("VALIDATE_NOTNULL"));
		}else{
 			if (LwxfStringUtils.getStringLength(this.microblogId) > 13) {
				validResult.put("microblogId", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
			}
		}
		...
		if (LwxfStringUtils.getStringLength(this.parentCreator) > 13) {
			validResult.put("parentCreator", AppBeanInjector.i18nUtil.getMessage("VALIDATE_LENGTH_TOO_LONG"));
		}
