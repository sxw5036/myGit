 ...
 * @create：2019/7/12/012 17:30
 * @version：2019 Version：1.0
 * @company：老屋新房 Created with IntelliJ IDEA
 */
@RestController
@RequestMapping(value = "/api/f/aftersales", produces = WebConstant.RESPONSE_CONTENT_TYPE_JSON_CHARTSET)
@Api(value = "PaymentPrintTableController", tags = {"pc端后台接口:售后单打印信息管理"})
public class AftersalePrintTableController {
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "获取售后单打印信息",response = AftersalesPrintTableDto.class)
	private RequestResult findAftersalesPrintInfo(@PathVariable String id){
		return this.aftersaleApplyFacade.findAftersalesPrintInfo(id);
	}
