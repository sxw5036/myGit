...
public final class ResultFactory {
	 ...
	 * 生成正常请求结果对象
	 * @param result：
	 *    分页对象：com.lwxf.industry4.webapp.common.model.PaginatedList
	 ...
	 * @return
	 */
	public static RequestResult generateRequestResult(List<Map<String,Object>> datas, Pagination pagination){
		return RequestResult.newInstance(datas,pagination);
	}
	...
	/*public static void main(String args[]){
		...
		com.lwxf.industry4.webapp.common.model.Pagination pagination = new Pagination();
