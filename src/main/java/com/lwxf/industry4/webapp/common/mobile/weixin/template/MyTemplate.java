package com.lwxf.industry4.webapp.common.mobile.weixin.template;
...
public class MyTemplate {
    ...
    public void test10(){
        ...
        List<UserThirdInfo> clerks = AppBeanInjector.userThirdInfoService.findAllClerks(WebUtils.getCurrCompanyId());
        if (clerks.size()!=0){
