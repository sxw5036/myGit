package com.lwxf.industry4.webapp.common.mobile;
...
import com.lwxf.industry4.webapp.config.wxpay.WxPayProperties;
...
import com.lwxf.industry4.webapp.baseservice.rabbitmq.MessageScope;
...
import com.lwxf.industry4.webapp.common.mobile.weixin.template.ImgJsonMsg;
import com.lwxf.industry4.webapp.common.mobile.weixin.template.TextJsonMsg;
import com.lwxf.industry4.webapp.common.utils.ExceptionGenerateFactory;
...
import static com.lwxf.industry4.webapp.facade.AppBeanInjector.userThirdInfoFacade;
import static com.lwxf.industry4.webapp.facade.AppBeanInjector.weixinCfg;
...
public abstract class WeixinUtils {
	...
	private static String SCENE_INFO_KEY_H5_INFO="h5_info";
	private static String SCENE_INFO_KEY_TYPE="type";
	private static String SCENE_INFO_KEY_TYPE_IOS="IOS";
	private static String SCENE_INFO_KEY_TYPE_ANDROID="Android";
	private static String SCENE_INFO_KEY_APPNAME="app_name";
	private static String SCENE_INFO_KEY_BUNDLE_ID="bundle_id";
	private static String SCENE_INFO_KEY_BUNDLE_ID_VALUE="com.tencent.wzryIOS";
	private static String SCENE_INFO_KEY_PACKAGE_NAME="package_name";
	private static String SCENE_INFO_KEY_PACKAGE_NAME_VALUE="com.tencent.tmgp.sgame";

	public static String getSceneInfo(WxPayProperties payProperties){
		JsonMapper jsonMapper = new JsonMapper();
		Map<String,Map<String,String>> scene = new HashMap<>();
		Map<String,String> sceneInfo = new HashMap<>();
		scene.put(SCENE_INFO_KEY_H5_INFO,sceneInfo);
		sceneInfo.put(SCENE_INFO_KEY_APPNAME,payProperties.getAppname());
		LwxfUserAgent userAgent = WebUtils.getUserAgent();
		if(userAgent.isIOS()){
			sceneInfo.put(SCENE_INFO_KEY_TYPE,SCENE_INFO_KEY_TYPE_IOS);
			sceneInfo.put(SCENE_INFO_KEY_BUNDLE_ID,SCENE_INFO_KEY_BUNDLE_ID_VALUE);
		} else if(userAgent.isAndroid()){
			sceneInfo.put(SCENE_INFO_KEY_TYPE,SCENE_INFO_KEY_TYPE_ANDROID);
			sceneInfo.put(SCENE_INFO_KEY_PACKAGE_NAME,SCENE_INFO_KEY_PACKAGE_NAME_VALUE);
		}else { // 其他默认为安卓
			sceneInfo.put(SCENE_INFO_KEY_TYPE,SCENE_INFO_KEY_TYPE_ANDROID);
			sceneInfo.put(SCENE_INFO_KEY_PACKAGE_NAME,SCENE_INFO_KEY_PACKAGE_NAME_VALUE);
		}
		return jsonMapper.toJson(scene);
	}
}
