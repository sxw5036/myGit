...
public class Configuration {
	...
	@Value("${lwxf.user.default.avatar:https://cdn.easypm.cn/system/man.png}")
...
//	private String uploadPath;
	 ...
	 * 上传文件的contextPath
	 */
	@Value("${upload.file.contextPath}")
	private String uploadFileContextPath;
	/**
	 * 上传头像的文件范围
	 */
	 ...
	 * 上传APK的文件范围
	 */
	@Value("${upload.apk.mime.range:application/vnd.android.package-archive}")
	private String uploadApkMimeRange;
	/**
	 * 上传文件的限制大小，单位M
	 */
	 ...
	 * 上传头条资讯路径
	 */
	@Value("${upload.file.upload.component.modulePathMapping.headline}")
	private String uploadHeadlineFile;
	@Value("${upload.background.maxsize:5}")
	private int uploadBackgroundMaxsize;
	@Value("${upload.apk.maxsize:50}")
	private int uploadApkMaxSize;
	@Value("${page.size.limit:50}")
	private int pageSizeLimit;
	@Value("${system.reserved.keys:all|lwxf|goods}")
	private String systemReservedKeys;
	@Value("${lwxf.uniqunecode.flag}")
	private String uniquneCodeFlag;
...
//
	...
	public int getUploadApkMaxSize() {
		return uploadApkMaxSize;
	}

	public void setUploadApkMaxSize(int uploadApkMaxSize) {
		this.uploadApkMaxSize = uploadApkMaxSize;
	}
	...
	public String getUploadApkMimeRange() {
		return uploadApkMimeRange;
	}

	public void setUploadApkMimeRange(String uploadApkMimeRange) {
		this.uploadApkMimeRange = uploadApkMimeRange;
	}
	...
	public String getUploadHeadlineFile() {
		return uploadHeadlineFile;
	}

	public String getUploadFileContextPath() {
		return uploadFileContextPath;
	}

	public void setUploadFileContextPath(String uploadFileContextPath) {
		this.uploadFileContextPath = uploadFileContextPath;
	}
	 ...
	 * @return
	 */
	public String getUniquneCodeFlag() {
		return uniquneCodeFlag;
	}
