package com.lwxf.industry4.webapp.common.jmail.impl;
...
import com.lwxf.industry4.webapp.common.jmail.MailSend;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.*;
...
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.AbstractSendCloudMailSend;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.CommonMail;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.IMSendExceptionMail;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.OnlineMail;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.ResetPasswordMail;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.SendCloudCfg;
import com.lwxf.industry4.webapp.common.jmail.sendcloudmail.UpdatePasswordMail;
import com.lwxf.industry4.webapp.common.shiro.ShiroUtil;
import com.lwxf.industry4.webapp.common.utils.ExceptionGenerateFactory;
...
//		sender.setLoginName("system");
	...
	public MailSend createMailSend(String mailSendSimpleCalssName) {
		...
		if (null == mailSend) {
			String message = mailSendSimpleCalssName + "在com.lwxf.app.domain.service.jmail.sendcloudmail包中未定义";
