package com.lwxf.industry4.webapp.baseservice.zaoyi.domain.dao.base;
...
public abstract class BaseNoIdDaoImpl<T> implements BaseNoIdDao<T> {
    ...
    public List<T> findAll() {
        return this.getSqlSession().selectList(this.getNamedSqlId("findAll"));
    }

    @Override
    public List<T> findListByParams(Map<String,Object> params) {
        return this.getSqlSession().selectList(this.getNamedSqlId("findListByParams"), params);
    }
