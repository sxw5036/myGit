package com.lwxf.industry4.webapp.baseservice.tsmanager.util;
 ...
 * <p>
 * AuditPackageScan packageScan = new AuditPackageScan("com.lwxf.app.webapp.domain.entity", IdEntity.class);
 * packageScan.execute();
...
public class AuditPackageScan {
	...
	public static void generateTableMapping() {
		String packageName = "com.lwxf.app.webapp.domain.entity";
